  ...
  return (
    ...
    >
      <div className="flex items-center space-x-3">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Results by Target</h1>
          <p className="text-gray-600">Resultados organizados por alvo</p>
        </div>
      </div>
      ...
      <Card className="p-8 text-center">
        ...
        <h2 className="text-xl font-semibold text-gray-900 mb-2">
          Results by Target em Desenvolvimento
        </h2>
